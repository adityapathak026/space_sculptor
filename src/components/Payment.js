...
const Payment = ({
  ...
  const options = {
    ...
    name: 'John Doe', // Title for your organization to display in checkout modal
    ...
    handler: (response) => {
      ...
      const succeeded = crypto.HmacSHA256(`${orderId}
      |${response.razorpay_payment_id}`, keySecret).toString() === response.razorpay_signature;
